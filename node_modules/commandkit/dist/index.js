...
function permissions_default({ interaction, targetCommand }) {
  ...
  missingUserPermissions = missingUserPermissions.map((p) => p.replace(pattern, "$1$3 $2$4"));
  missingBotPermissions = missingBotPermissions.map((p) => p.replace(pattern, "$1$3 $2$4"));
